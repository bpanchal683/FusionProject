...
public class MSD extends BaseTest {
    ...
    public void msd(Map<String, String> data) throws InterruptedException {
        ...
        //Create New Case
        MsdSignInPage msdSignInPage=new MsdSignInPage(getDriver());
        msdSignInPage.enterMail("AlexW@w53j6.onmicrosoft.com");
        msdSignInPage.enterPassword("Poha@68102");
        msdSignInPage.staySignIn();
        AppsPage appsPage=new AppsPage(getDriver());
        appsPage.clickFieldService();
        FieldServicesPage fieldServicesPage=new FieldServicesPage(getDriver());
        ...
        FieldServicePage fieldServicePage=new FieldServicePage(getDriver());
        ...
        WorkOrderNumberPage workOrderNumberPage=new WorkOrderNumberPage(getDriver());
        ...
        ScheduleBoardPage scheduleBoardPage=new ScheduleBoardPage(getDriver());
        ...
        ActiveWorkOrdersPage activeWorkOrdersPage=new ActiveWorkOrdersPage(getDriver());
        activeWorkOrdersPage.clickWorkOrderNumber();
        WorkOrderPage workOrderPage=new WorkOrderPage(getDriver());
        ...
        fieldServicesPage.clickCases();
        MyActiveCasesPage myActiveCasesPage=new MyActiveCasesPage(getDriver());
